...
from .vae_blocks_sd3 import UNetMidBlock2D, get_down_block, get_up_block
...
class DecoderWith3DWrapper(Decoder):
    def __init__(
        self,
        in_channels: int = 3,
        out_channels: int = 3,
        ...
        super().__init__(
            ...
            act_fn=act_fn,
            norm_type=norm_type,  # group, spatial
